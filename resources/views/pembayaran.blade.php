...
<body>
    ...
    <script>
         function tambahBarang() {
            ...
            cell4.innerHTML = hargaSatuan.toFixed(0);
            cell5.innerHTML = total.toFixed(0);
        ...
        function updateTotalHarga() {
            ...
            document.getElementById("totalHarga").innerHTML = total.toFixed(0);
        }
        ...
        function order() {
            ...
            alert("Order berhasil! Nama Pelanggan: " + namaPelanggan + ", Total Harga: rp" + totalHarga.toFixed(0));
