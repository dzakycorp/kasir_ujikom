...
<body>
    ...
    <div class="struk">
        <div class="header">
            <p style="font-size:20px;">D K A S I R</p>
        </div>
        <div class="address">
            <p>jalan cariu permai No 12</p>
            <p>Telp. 0859148322167 </p>
        ...
        <div class="content">
            ...
            <div class="total">
                ...
                <p>Rp. {{ number_format($penjualan->total_harga, 0, ',', '.') }}</p>
            </div>
            <p>-----------------------------------------------------------------------------------------------</p>
        </div>
        <div class="payment">
        ...
        <div class="footer">
            ...
            <p>barang yang sudah di beli tidak bisa di kembalikan</p>
        </div>
    </div>
